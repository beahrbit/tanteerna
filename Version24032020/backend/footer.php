	...
	<div id="footer-menu-container" class="fill-width">
		...
		<div class="footerinhaltLogos">
			<a href="https://www.instagram.com/yourspec.de/?igshid=avpmmu62mtsb">
				<img src="../../media/images/misc/instagram.png" alt="Error404" height="50" width="50">
			</a>
		</div>
		<div class="footerinhaltLogos">
			<img src="../../media/images/misc/fb.png" alt="Error404" height="50" width="50">
		</div>
	</div>
	<div id="copyright-container" class="fill-width">
		<a id="copyright-content">Copyright @Yourspec Digital Marketing</a>
	</div>
</div>